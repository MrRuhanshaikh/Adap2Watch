...
const MoviesShowsPageDesktop = () => {
  return (
    <div className="w-full relative bg-black-08 overflow-hidden flex flex-col items-start justify-start gap-[0px] leading-[normal] tracking-[normal] mq825:gap-[37px] mq1250:gap-[75px]">
