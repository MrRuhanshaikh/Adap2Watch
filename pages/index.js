...
import TopContent1 from "../components/top-content1";
    ...
    <div className="overflow-x-hidden w-full relative bg-black-08 flex flex-col items-start justify-start gap-3.5 leading-[normal] tracking-[normal] text-center text-[58px] text-absolute-white font-manrope">
      <div className="self-stretch flex flex-col items-start justify-start max-w-full">
        <div className="self-stretch h-[860px] flex flex-col items-start justify-start relative gap-5 mq1825:h-auto mq1825:min-h-[860]">
          ...
          <TopContent1 />
          <img
            className="w-[470px] h-[470px] absolute !m-[0] top-[calc(50%_-_235px)] left-[calc(50%_-_235px)] z-[4]"
            alt=""
            src="/abstract-design.svg"
          />
        </div>
        <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full mt-[-64px]">
          <h1 className="m-0 w-[1096px] relative text-inherit leading-[150%] font-bold font-[inherit] inline-block shrink-0 max-w-full z-[5] mq450:text-[35px] mq450:leading-[52px] mq925:text-[46px] mq925:leading-[70px]">
      ...
      <main className="self-stretch flex flex-row items-start justify-center pt-0 pb-[136px] pl-5 pr-[21px] box-border max-w-full mq925:pb-6 mq925:box-border mq1350:pb-[37px] mq1350:box-border">
        <section className="w-[1597px] flex flex-col items-end justify-start gap-[150px] max-w-full text-left text-lg text-absolute-white font-manrope mq450:gap-[19px] mq925:gap-[37px] mq1350:gap-[75px]">
          <div className="self-stretch flex flex-row items-start justify-center pt-0 pb-[50px] pl-[21px] pr-5 box-border max-w-full text-center text-grey-60">
            <div className="w-[1096px] flex flex-col items-start justify-start gap-[50px] max-w-full mq925:gap-[25px]">
          ...
          <FrameComponent1 />
          <Container11 />
          <div className="self-stretch flex flex-col items-center justify-start gap-20 max-w-full mq450:gap-5 mq925:gap-10">
            <Container />
            <div className="self-stretch flex flex-row items-start justify-start flex-wrap content-start gap-20 max-w-full mq450:gap-5 mq925:gap-10">
              <div className="flex-1 flex flex-col items-start justify-start min-w-[493px] max-w-full mq925:min-w-full">
                <FAQItemOpen />
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-20 max-w-full text-19xl mq450:gap-5 mq925:gap-10">
            <div className="self-stretch flex flex-row items-end justify-between max-w-full gap-5 mq1825:flex-wrap">
          ...
          <div className="self-stretch h-[313px] rounded-xl bg-black-06 border-black-15 border-[1px] border-solid box-border overflow-hidden shrink-0 flex flex-row items-start justify-start max-w-full text-29xl mq1825:h-auto">
            <div className="mt-[-41px] w-[1646px] flex flex-row items-start justify-start py-[141px] px-20 box-border relative gap-[100px] shrink-0 max-w-[104%] mq450:gap-[25px] mq450:pt-[92px] mq450:pb-[92px] mq450:box-border mq925:gap-[50px] mq1350:pl-10 mq1350:pr-10 mq1350:box-border mq1825:flex-wrap">
              <div className="flex-1 !m-[0] absolute w-[calc(100%_-_50px)] top-[0px] right-[50px] left-[0px] flex flex-row items-start justify-center gap-5 mq1825:flex-wrap">
                <img
              ...
              <div className="flex-1 !m-[0] absolute w-[calc(100%_-_50px)] top-[103.8px] right-[50px] left-[0px] flex flex-row items-start justify-center gap-5 mq1825:flex-wrap">
                <img
                  className="self-stretch flex-1 relative max-w-[165px] overflow-hidden max-h-full object-cover min-w-[162px] min-h-[84px]"
                  alt=""
                  src="/image-19@2x.png"
              ...
              <div className="flex-1 !m-[0] absolute w-[calc(100%_-_50px)] right-[50px] bottom-[103.7px] left-[0px] flex flex-row items-start justify-center gap-5 mq1825:flex-wrap">
                <img
                  className="self-stretch flex-1 relative max-w-[165px] overflow-hidden max-h-full object-cover min-w-[162px] min-h-[84px]"
                  alt=""
                  src="/image-28@2x.png"
              ...
              <div className="flex-1 !m-[0] absolute w-[calc(100%_-_50px)] right-[50px] bottom-[-0.1px] left-[0px] flex flex-row items-start justify-center gap-5 mq1825:flex-wrap">
                <img
                  className="self-stretch flex-1 relative max-w-[165px] overflow-hidden max-h-full object-cover min-w-[162px] min-h-[84px]"
                  alt=""
                  src="/image-37@2x.png"
              ...
              <div className="w-[1148px] flex flex-col items-start justify-start gap-3.5 max-w-full">
                <h1 className="m-0 self-stretch relative text-inherit leading-[150%] font-bold font-[inherit] z-[2] mq450:text-10xl mq450:leading-[43px] mq925:text-19xl mq925:leading-[58px]">
