...
const SupportPageDesktop = () => {
  return (
    <div className="w-full relative bg-black-08 overflow-hidden flex flex-col items-start justify-start gap-[150px] leading-[normal] tracking-[normal] mq1250:gap-[75px] mq825:gap-[37px]">
      <section className="self-stretch flex flex-col items-end justify-start gap-[115px] max-w-full mq1250:gap-[57px] mq825:gap-[29px]">
        <Navbar2 />
        <FrameComponent2 />
      </section>
      <FrameComponent3 />
...
export default SupportPageDesktop;
