  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-col items-start justify-start py-0 pl-0 pr-5 box-border gap-3.5 max-w-full">
        <h1 className="m-0 w-[1297px] relative text-inherit leading-[150%] font-bold font-[inherit] inline-block max-w-full mq450:text-4xl mq450:leading-[34px] mq925:text-11xl mq925:leading-[46px]">
      ...
      <div className="self-stretch flex flex-row items-start justify-start flex-wrap content-start gap-x-[30px] gap-y-[28.1px] min-h-[596px] max-w-full text-5xl">
