...
const Navbar2 = ({ className = "" }) => {
  return (
    <header
      className={`self-stretch h-[120px] flex flex-row items-center justify-between pt-[22px] px-[162px] pb-[23px] box-border relative gap-5 text-left text-lg text-grey-75 font-manrope mq825:pl-[81px] mq825:pr-[81px] mq825:box-border mq450:pl-5 mq450:pr-5 mq450:box-border ${className}`}
    >
      ...
      <div className="!m-[0] absolute top-[calc(50%_-_42px)] left-[calc(50%_-_296.5px)] rounded-xl bg-black-06 border-black-12 border-[4px] border-solid overflow-hidden flex flex-row items-center justify-start py-[5px] px-9 gap-[30px]">
        ...
        <button className="cursor-pointer border-black-10 border-[1px] border-solid py-3 px-[23px] bg-black-10 rounded-lg flex flex-row items-center justify-start hover:bg-dimgray-300 hover:border-dimgray-300 hover:border-[1px] hover:border-solid hover:box-border">
          <div className="relative text-lg leading-[150%] font-medium font-manrope text-absolute-white text-left inline-block min-w-[69px]">
