...
const FAQItemOpen = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-start p-[34px] box-border gap-5 max-w-full shrink-0 text-left text-xl text-absolute-white font-manrope mq925:flex-wrap ${className}`}
    >
      ...
      <div className="flex-1 flex flex-col items-start justify-start gap-5 min-w-[363px] max-w-full text-3xl mq925:min-w-full">
